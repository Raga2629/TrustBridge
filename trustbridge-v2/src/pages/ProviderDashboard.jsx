        ...
        <div className="welcome-section">
          ...
          <div className="verification-badge">
            {user.isPhoneVerified ? (
              ...
              <span className="badge-pending">📱 Complete Phone Verification</span>
            )}
          </div>
        </div>
            ...
            {services.length === 0 ? (
              ...
              <div className="services-grid">
                {services.map(service => (
                  <div key={service._id} className={`service-card ${service.approvalStatus === 'pending' ? 'service-pending' : service.approvalStatus === 'rejected' ? 'service-rejected' : ''}`}>
                    ...
                    {service.approvalStatus === 'pending' && (
                      <div className="approval-banner pending">
                        ⏳ Pending Admin Approval — not visible to public yet
                      </div>
                    )}
                    {service.approvalStatus === 'rejected' && (
                      <div className="approval-banner rejected">
                        ❌ Rejected by Admin{service.approvalNote ? `: ${service.approvalNote}` : ''}
                      </div>
                    )}
                    ...
                    <div className="service-meta">
                      ...
                      <span>⭐ {service.rating?.toFixed(1) || '0.0'} ({service.totalReviews || 0} reviews)</span>
                    </div>
